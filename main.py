...
def generate_members():
    ...
    try:
        money = balance()
        ctypes.windll.kernel32.SetConsoleTitleW(f'Token Generator | Generated ~ {generated} | Solved ~ {cap_solved} | Errors ~ {errors} | Proxy Error ~ {proxy_error}')
            ...
            with output_lock:
                ...
                with open("config.json") as f:
                        ...
                        if a['online_tokens'] == "y":
                            ...
                            details = "discord.gg/freecloud"
                            state = "github.com/zenithail"
                            name = "Zenithail H4X"
